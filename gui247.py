...
button1 = Button(frame, text = 'function 1', fg='black', command=function1a).grid(row=1,column=1)
button1 = Button(frame, text='function 1', fg='black', command=function1a_background)
